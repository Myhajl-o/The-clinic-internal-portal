...
## Якщо тект в програмі криво відображається, то потрібно потрібно поставити UTF-8

### win+r -> intl.cpl -> enter (відкриються Регіональні настройки) -> Адміністрування -> Змінити мовні параметри системи -> Потрібно поставити галочку на: Бета-версія: Використовуйте Unicode UTF-8 для підтримки мови по всьому світу -> OK -> OK або застосувати       
